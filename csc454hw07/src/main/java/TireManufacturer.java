public class TireManufacturer extends Model<Order, Tire> {

    int TIME_TO_PROCESS_PIECE;
    double timeRemainingOnPiece;

    public TireManufacturer(Port<Order> in, Port<Tire> out) {
    ...
    public String lambda() {
        ...
        this.out.currentValue = new Tire("tire");
        return "Tire was created";
    ...
    public void externalTransition(Time currentTime, String in) {
        ...
        this.numberOfPartsToProcess += order.numberOfTires;
    ...
    public String toString() {
        return "Tire manufacturer - Pieces: " + this.numberOfPartsToProcess + " Time left: " + this.timeRemainingOnPiece;
    }
}
