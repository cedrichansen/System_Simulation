public class BatteryManufacturer extends Model<Order, Battery> {

    int TIME_TO_PROCESS_PIECE;
    double timeRemainingOnPiece;

    public BatteryManufacturer(Port<Order> in, Port<Battery> out) {
    ...
    public String lambda() {
        ...
        this.out.currentValue = new Battery("battery");
        return "Battery was created";
    ...
    public void externalTransition(Time currentTime, String in) {
        ...
        this.numberOfPartsToProcess += order.numberOfBatteries;
    ...
    public String toString() {
        return "Battery manufacturer - Pieces: " + this.numberOfPartsToProcess + " Time left: " + this.timeRemainingOnPiece;
    }
}
