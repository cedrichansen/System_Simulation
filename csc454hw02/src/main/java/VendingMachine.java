public class VendingMachine {
    ...
    private void processAction(String command) {
        ...
        if (command.equals("w")) {
            ...
            System.out.println("change button pressed. Change will be dispensed on next tik");
            ...
            if (!command.equals("exit")) {
                ...
                System.out.println("Closing the vending machine...");
            }
        }
    ...
    public String toString() {
        return "Nickels: " + numberOfNickels + " Dimes: " + numberOfDimes + " Quarters: " + numberOfQuarters
                + "\nBalance: " + customerValue / 100 + " current tik " + tikNumber;
    }
